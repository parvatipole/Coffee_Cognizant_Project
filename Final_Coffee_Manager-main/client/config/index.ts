...
export const SUPPLY_NAMES = {
  [SUPPLY_TYPES.WATER]: "Water Tank",
  [SUPPLY_TYPES.MILK]: "Milk Container",
  [SUPPLY_TYPES.COFFEE_BEANS]: "Coffee Beans",
  [SUPPLY_TYPES.SUGAR]: "Sugar Container",
} as const;
...
export const generateRoute = {
  machineDetail: (machineId: string) => `/machine/${machineId}`,
  office: (officePath: string) => `/office/${officePath}`,
  officeSpecific: (officePath: string, machineId?: string) => 
...
export const TIME_CONFIG = {
  SYNC_INTERVAL_MS: parseInt(import.meta.env.VITE_SYNC_INTERVAL || "30000"), // 30 seconds
  ALERT_REFRESH_MS: parseInt(import.meta.env.VITE_ALERT_REFRESH || "5000"), // 5 seconds
...
export const STATUS_COLORS = {
  ...
  [MACHINE_STATUS.MAINTENANCE]: "orange", 
  [MACHINE_STATUS.OFFLINE]: "red",
  [ALERT_PRIORITIES.LOW]: "blue",
  [ALERT_PRIORITIES.MEDIUM]: "yellow",
  [ALERT_PRIORITIES.HIGH]: "orange",
  [ALERT_PRIORITIES.CRITICAL]: "red",
} as const;
